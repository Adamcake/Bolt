...
int wmain(int argc, const wchar_t **argv)
{
    if (argc != 2)
    {
        std::cerr << "stub_generator must be called with exactly one argument, the absolute path to the stub DLL." << std::endl;
        return 1;
    }
    ...
    std::cout << "#include <Windows.h>" << std::endl << "#include <cstdint>" << std::endl;
    // embed dll headers

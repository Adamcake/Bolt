...
export const rs3DebInstalledHash: Writable<string | null> = writable('');
export const rs3ExeInstalledHash: Writable<string | null> = writable('');
export const rs3AppInstalledHash: Writable<string | null> = writable('');
export const osrsExeInstalledHash: Writable<string | null> = writable('');
export const osrsAppInstalledHash: Writable<string | null> = writable('');
